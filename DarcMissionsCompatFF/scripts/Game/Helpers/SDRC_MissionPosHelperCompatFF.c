...
modded class SDRC_MissionPosHelper
{
	...
	*/	
	override static SDRC_EMissionError IsValidMissionPos(vector pos, float distanceToMission = -1, float distanceToPlayer = -1, bool onlyBasicChecks = false, bool isRequested = false)	
	{	
