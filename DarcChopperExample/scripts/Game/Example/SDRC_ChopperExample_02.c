//Mission SDRC_ChopperExample_02.c
...
class SDRC_ChopperExample_02
{
	...
	void SDRC_ChopperExample_02()
	{
		...
		{
			SDRC_Log.Add("[SDRC_ChopperExample_02] Could not spawn chopper", LogLevel.ERROR);
			return;			
		}
