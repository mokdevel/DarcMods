//Mission SDRC_ChopperExample_01.c
...
class SDRC_ChopperExample_01
{
	...
	void SDRC_ChopperExample_01()
	{
		...
		{
			SDRC_Log.Add("[SDRC_ChopperExample_01] Could not spawn chopper", LogLevel.ERROR);
			return;			
		}
