...
If you're looking to have both US and FIA enemies randomly, just add "FIA" to ``enemyFactions`` in ``dc_missionConfig.json``. Like this: "enemyFactions": [ "US", "FIA" ],
In theory, I have not tested, having it like: "US", "US", "US", "FIA" would give 75% of missions to be US and 25% FIA.
