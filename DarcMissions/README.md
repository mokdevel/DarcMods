...
## Mission end
Once all AIs have been eliminated, the mission is kept alive a minimum of ```missionActiveTime * 0.5``` seconds. The time is reset if there is a player within ```missionActiveDistance```.
