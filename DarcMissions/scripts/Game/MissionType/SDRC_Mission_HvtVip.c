...
class SDRC_Mission_HvtVip : SDRC_Mission
{
	...
	void SDRC_Mission_HvtVip(SDRC_EMissionType missionType, SDRC_MissionRequested request, bool staticMission = false)
	{
		...
		m_Config.LoadMissionFiles(DC_MISSIONCONFIG_FILE_HVTVIP_JSONVER);
...
class SDRC_HvtVipConfig : SDRC_MissionConfig
{
	...
	{
		SDRC_Misc.GetFileList(missionFiles, SDRC_Conf.subDirPath, ".json", "dc_missionConfig_HvtVip_", true);
