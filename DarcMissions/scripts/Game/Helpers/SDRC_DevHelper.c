...
sealed class SDRC_DevHelper
{
	static void SDRC_DevDump()	
	{
		...
		SDRC_MapMarkerHelper.CreateMapMarker("2200 0 1000", DC_EMissionIcon.GM_MISSION_STASH_MAP, "DMC_B", "This is a description for a mission");
		SDRC_MapMarkerHelper.CreateMapMarker("2300 0 1000", DC_EMissionIcon.GM_MISSION_BIOHAZARD_MAP, "DMC_B", "This is a description for a mission");
		SDRC_MapMarkerHelper.CreateMapMarker("2400 0 1000", DC_EMissionIcon.GM_MISSION_CRATE_MAP, "DMC_B", "This is a description for a mission");
		SDRC_MapMarkerHelper.CreateMapMarker("2500 0 1000", DC_EMissionIcon.GM_MISSION_DEMON_MAP, "DMC_B", "This is a description for a mission");
		SDRC_MapMarkerHelper.CreateMapMarker("2600 0 1000", DC_EMissionIcon.GM_MISSION_DIAMOND_MAP, "DMC_B", "This is a description for a mission");
		SDRC_MapMarkerHelper.CreateMapMarker("2700 0 1000", DC_EMissionIcon.GM_MISSION_ZOMBIE_MAP, "DMC_B", "This is a description for a mission");
	
		SDRC_MapMarkerHelper.CreateMapMarker("1000 0 1300", DC_EMissionIcon.GM_MISSION_WIN_MAP, "DMC_B", "This is a description for a mission");
		SDRC_MapMarkerHelper.CreateMapMarker("1100 0 1300", DC_EMissionIcon.GM_MISSION_LOSE_MAP, "DMC_B", "This is a description for a mission");

		SDRC_MapMarkerHelper.CreateMapMarker("1000 0 1600", DC_EMissionIcon.ICON_DEATHMARKER_MAP, "DMC_B", "Here is a text");
		SDRC_MapMarkerHelper.CreateMapMarker("1100 0 1600", DC_EMissionIcon.ICON_DEATHMARKER_SMALL_MAP, "DMC_B", "Here is a text");
		SDRC_MapMarkerHelper.CreateMapMarker("1200 0 1600", DC_EMissionIcon.ICON_DEATHMARKER_SMALL_RED_MAP, "DMC_B", "Here is a text");
		SDRC_MapMarkerHelper.CreateMapMarker("1300 0 1600", DC_EMissionIcon.ICON_PLUS_SMALL_MAP, "DMC_B", "Here is a text");
		SDRC_MapMarkerHelper.CreateMapMarker("1400 0 1600", DC_EMissionIcon.ICON_EXCLAMATION_SMALL_MAP, "DMC_B", "Here is a text");
		SDRC_MapMarkerHelper.CreateMapMarker("1500 0 1600", DC_EMissionIcon.ICON_CRATE_SMALL_MAP, "DMC_B", "Here is a text");
