...
class SDRC_ChopperCrewHelper
{
	...
	{		
		...
		if (chopperComp.GetBehaviour() != SDRC_EHeliBehaviour.EVAC_BEHAVIOUR)
		{
		...
		{
			if ( (g == 0) && (chopperComp.GetBehaviour() != SDRC_EHeliBehaviour.EVAC_BEHAVIOUR) )
			{
